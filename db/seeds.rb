...
Anime.create(name: "Naruto" ,
    ...
    description: "Moments prior to Naruto Uzumaki's birth, a huge demon known as the Kyuubi, the Nine-Tailed Fox, attacked Konohagakure, the Hidden Leaf Village, and wreaked havoc. In order to put an end to the Kyuubi's rampage, the leader of the village, the Fourth Hokage, sacrificed his life and sealed the monstrous beast inside the newborn Naruto. Now, Naruto is a hyperactive and knuckle-headed ninja still living in Konohagakure. Shunned because of the Kyuubi inside him, Naruto struggles to find his place in the village, while his burning desire to become the Hokage of Konoha leads him not only to some great new friends, but also some deadly foes."
)

Anime.create(name: "Kimetsu no Yaiba" ,
    image: "https://cdn.myanimelist.net/images/anime/1286/99889.jpg",
    description: "When the main character, Tanjirou, arrives back home he is met with a horrifying sight—his whole family has been slaughtered. Worse still, the sole survivor is his sister Nezuko, who has been turned into a bloodthirsty demon. Consumed by rage and hatred, Tanjirou swears to avenge his family and stay by his only remaining sibling. Alongside the mysterious group calling themselves the Demon Slayer Corps, Tanjirou will do whatever it takes to slay the demons and protect the remnants of his beloved sister's humanity."
)

Anime.create(name:  "Jujutsu Kaisen",
...
Anime.create(name: "YuYu Hakusho" ,
    image: "https://cdn.myanimelist.net/images/anime/1993/102027.jpg",
    description: "One fateful day, Yuusuke Urameshi, a 14-year-old delinquent with a dim future, gets a miraculous chance to turn it all around when he throws himself in front of a moving car to save a young boy. His ultimate sacrifice is so out of character that the authorities of the spirit realm are not yet prepared to let him pass on. Koenma, heir to the throne of the spirit realm, offers Yuusuke an opportunity to regain his life through completion of a series of tasks. With the guidance of the death god Botan, he is to thwart evil presences on Earth as a Spirit Detective."
)

Anime.create(name: "Samurai Champloo",
...
Anime.create(name: "Hunter x Hunter",
    image: "https://cdn.myanimelist.net/images/anime/10/66303.jpg",
...
Anime.create(name: "Parasyte: The Maxim" ,
